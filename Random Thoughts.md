...
Ignore this file. It is a scratch space for my personal use. 

~ Corvus

---

As part of my real world self-education adventure using Claude in all his many faces to develop methodology for generating course materials more easily, I decided to take advantage of Anthropic's free access to Fable. Mainly I just wanted to see what all the hype was about.

Because I'm a miser when it comes to my tokens, I tend to use haiku or whatever the lightest model available is. As a result, I probably do spend more time than necessary iterating with my current LLM of choice, Claude, more than I need to. The problem is that I like the iterations. They help me refine my thinking and get clarity on what my real purpose is and what it is I'm trying to communicate. 

So I'm cruising along, using voice to text and working with Claude on a whole new framework concept I'm developing to streamline my ability to generate quality, organized, and detailed course materials. All the while, I'm using Haiku because I completely spaced on the fact that Anthropic decided to extend the "free taste" of Fable for Pro and Max level users. 

DOH! (Insert Homer Simpson meme.)



Fable was nowhere near as chatty, 
