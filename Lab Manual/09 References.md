...
Background on the control plane, the data plane, and NAT traversal, the concepts [[05 Tailscale Mesh Networking|lesson 05]] leans on when it explains why nothing gets exposed to the wider network.
...
Scoping which nodes on a tailnet may reach which others, the ACL idea referenced in [[05 Tailscale Mesh Networking]] and [[06 Locking It Down with nginx]] as the mesh level counterpart to putting auth on a service.
